...
public class Config {
    ...
    private static String buildSettings()
    {
        ...
        builtString += "FONT_DISABLED_COLOR:" + FONT_DISABLED_COLOR.getRed() + "," + FONT_DISABLED_COLOR.getGreen() + "," + FONT_DISABLED_COLOR.getBlue() + "," + FONT_DISABLED_COLOR.getAlpha() + ";";
        ...
        builtString += "VIEWER_SHADING:" + VIEWER_SHADING + ";";
            ...
            while (myReader.hasNextLine()) {
                ...
                for(String settingData : fileData.split(";"))
                {
                    ...
                    switch (setting.toUpperCase())
                    {
                        ...
                        case "FONT_DISABLED_COLOR" : FONT_DISABLED_COLOR = new Color(Integer.parseInt(d[0]), Integer.parseInt(d[1]), Integer.parseInt(d[2]), Integer.parseInt(d[3])); break;
                        ...
                        case "VIEWER_SHADING" : VIEWER_SHADING = Integer.parseInt(data); break;
        ...
        loop : for(int i = 0; i < variables.size(); i++)
        {
            ...
            switch (i)
            {
                ...
                case 17:
                    ...
                    break;
                case 18:
                    if(!o.equals(FONT_DISABLED_COLOR))
                    {
                        hasChanged = true;
                        updateVariables();
                        break loop;
    ...
    private static void updateVariables()
    {
        ...
        variables.add(FONT_DISABLED_COLOR);
