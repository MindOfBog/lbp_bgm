...
public class Triangle extends TriStrip{
    ...
    public Triangle(ObjectLoader loader, WindowMan window, Color color, Vector2f p1, Vector2f p2, Vector2f p3) {
        ...
        this.scale = new Vector2f(window.getWidth(), window.getHeight());
    ...
    {
        return loader.loadModel(new float[]{(p1.x / (window.getWidth() / 2f)) - 1f, 2f * (1f - (p1.y / window.getHeight())) - 1f,
                (p2.x / (window.getWidth() / 2f)) - 1f, 2f * (1f - (p2.y / window.getHeight())) - 1f,
                (p3.x / (window.getWidth() / 2f)) - 1f, 2f * (1f - (p3.y / window.getHeight())) - 1f});
    }
