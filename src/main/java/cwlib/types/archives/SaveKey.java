...
public class SaveKey {
    @SuppressWarnings("unused") private final int[] deprecated1 = new int[10];
    private boolean copied;
    private ResourceType rootType = ResourceType.INVALID;
    @SuppressWarnings("unused") private final int[] deprecated2 = new int[3];
    private SHA1 rootHash = new SHA1();
    @SuppressWarnings("unused") private final int[] deprecated3 = new int[10];
